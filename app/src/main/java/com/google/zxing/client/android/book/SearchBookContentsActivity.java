 ...
 */
@SuppressLint("NewApi") public final class SearchBookContentsActivity extends Activity {
  ...
  @SuppressLint("NewApi") @TargetApi(Build.VERSION_CODES.GINGERBREAD) private void launchSearch() {
  ...
  private final class NetworkTask extends AsyncTask<String,Object,JSONObject> {
    ...
    @TargetApi(Build.VERSION_CODES.GINGERBREAD) @SuppressLint("NewApi") private SearchBookContentsResult parseResult(JSONObject json) {
