 ...
 */
@TargetApi(Build.VERSION_CODES.GINGERBREAD) @SuppressLint("NewApi") public final class ShareActivity extends Activity {
   ...
   */
  @TargetApi(Build.VERSION_CODES.GINGERBREAD) @SuppressLint("NewApi") private void showContactAsBarcode(Uri contactUri) {
