 ...
 * @author Sean Owen
 */
@TargetApi(Build.VERSION_CODES.GINGERBREAD) @SuppressLint("NewApi") public abstract class ResultHandler {
  ...
  @TargetApi(Build.VERSION_CODES.GINGERBREAD) @SuppressLint("NewApi") final void addContact(String[] names,
                        String[] nicknames,
   ...
   */
  @SuppressLint("NewApi") final void launchIntent(Intent intent) {
    try {
