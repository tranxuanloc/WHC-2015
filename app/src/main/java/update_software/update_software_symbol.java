...
import update_software.Update_Software.DownloadFileAsync;
...
public class update_software_symbol {
    public static final int DIALOG_DOWNLOAD_PROGRESS = 0;
    private ProgressDialog mProgressDialog;
    Activity _Activity;
	String _Path = "/sdcard/Download/WHC-2015_Symbol.apk";
    public update_software_symbol(Activity PActivity){
 ...
 class DownloadFileAsync extends AsyncTask<String, String, String> {
			...
			if (PCheckingInternet.CheckingInternet())
			{
				try {
					...
					OutputStream output = new FileOutputStream("/sdcard/Download/WHC-2015_Symbol.apk");
